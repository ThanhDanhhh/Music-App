...
public class DialogThemVaCapNhatNgheSi extends DialogFragment {
    EditText txtTenNgheSi, txtThongTinThem, txtThemNgheSi;
    ImageView ivAnhNgheSi, ivCloseDialog;
    ...
    private void uploadArtist() {
        ...
        NgheSi ngheSi = new NgheSi("", tenNgheSi, thongTinThem, "", 0, 0);
        DAO_NgheSi.uploadArtist(uri, getContext(), ngheSi, txtThemVaSuaNgheSi);
    ...
    private void updateArtist(){
        ...
        NgheSi ngheSi = new NgheSi("", tenNgheSi, thongTinThem, urlAnh, 0, 0);
        DAO_NgheSi.updateArist(uri, getContext(), ngheSi, txtThemVaSuaNgheSi);
    }
