...
public class MainActivity extends AppCompatActivity {
    ...
    private void ifUserIsAnAdmin() {
        if (isUserAnAdmin()) {
            ...
            setOnClickToolbarAction1(listener1, R.drawable.ic_more);
            ...
            setOnClickToolbarAction2(listener2, R.drawable.ic_repeat);
        } else {
            ...
            setOnClickToolbarAction1(listener, R.drawable.ic_search);
        }
    }
    ...
    public void changeToNhacDangNgheFragment(ArrayList<Nhac> dsn) {
        ...
        rlMusicController.setVisibility(View.VISIBLE);
    ...
    public void changeToNhacTheoChuDeFragment(TheLoai theLoai){
        fragmentManager.beginTransaction().replace(R.id.fragmentContainer, new NhacTheoChuDeFragment(theLoai.getTenTheLoai()));
    }
    ...
    public void setSongInformation(String tenNhac, String tenNgheSi, int seekBarMax) {
        if (tenNhac.length() > 25) {
            String cutText = tenNhac.substring(0, 22) + "...";
            txtTenNhac.setText(cutText);
        } else {
            txtTenNhac.setText(tenNhac);
        }
        if (tenNgheSi.length() > 25) {
            String cutText = tenNgheSi.substring(0, 22) + "...";
    ...
    public void setOnClickToolbarAction1(View.OnClickListener listener, int drawableID) {
        ivAction1.setImageResource(drawableID);
        ivAction1.setOnClickListener(listener);
    }

    public void setOnClickToolbarAction2(View.OnClickListener listener, int drawableID) {
        ivAction2.setVisibility(View.VISIBLE);
