...
public class DAO_NguoiDung {
    ...
    public static void changeUserPhoto(final Uri uri, final Context context, final DialogDoiAnhDaiDien dialog, final String maNguoiDung){
        final DatabaseReference myDatabaseRef = FirebaseDatabase.getInstance().getReference("NguoiDung");
        ...
        }).addOnSuccessListener(new OnSuccessListener<Task<Uri>>() {
            @Override
            public void onSuccess(Task<Uri> uriTask) {
                String urlAnh = uriTask.toString();
